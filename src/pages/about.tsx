...
const aboutUs = (): React.ReactElement => {
  return (
    <div className='w-[100vw] mx-auto h-[100vh]'>
      ...
      {/* Intro Section */}
      <div className='inline-block md:flex items-center  mx-auto px-4 max-w-7xl text-left'>
        <div className=' max-w-[500px] flex flex-col items-start justify-start mx-auto'>
